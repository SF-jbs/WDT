"""
queries/query_failed_transactions_failed_transactions.py
...
DESCRIPTION = (
    "Checks for all failed transactions in the masterstaging table for the following poster types: InventoryAdjustment, OrderAcknowledgement, InventoryStatus, TrailerStatus, OrderDetailChange, ShipLoad, PorkHotCarcass."
)

"""
queries/query_iws_delay_iws_pending.py
...
DESCRIPTION = (
    "Gets the count of PENDING outbound messages today, grouped by message type. WARNING: Must be connected to the IWS DB server."
)

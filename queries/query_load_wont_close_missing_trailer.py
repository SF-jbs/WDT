"""
queries/query_load_wont_close_missing_trailer.py
...
DESCRIPTION = (
    "Checks whether the shipment linked to this delivery has a trailer assigned. Returns ok if no shipment exists."
)

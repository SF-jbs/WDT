"""
scenarios/scenario_load_wont_close.py
...
class ScenarioLoadWonTClose(tk.Frame):
    ...
    def _build(self):
        ...
        inp.pack(fill="x")
        styled_label(inp, "Delivery Number", color=PALETTE["text"], font=FONT_HEAD).pack(anchor="w", pady=(0, 4))
        row_delivery_number = tk.Frame(inp, bg=PALETTE["surface"])
        row_delivery_number.pack(fill="x", pady=(0, 8))
        self._param_vars["delivery_number"] = tk.StringVar()
        e_delivery_number = styled_entry(row_delivery_number, width=28)
